...
export const Help = () => 
    <ul className='help'>
        ...
        <li>
            Use the "Player Images" button to move to the location of player-owned images (typically
            their character tokens).
        </li>
        <li>
            Save the current viewport by typing a name in the input field and pressing OK. You and
            other players can now return to it anytime.
        </li>
        <li>
